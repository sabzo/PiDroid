...
import sintu.com.pidroid.client.Client;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setHandler() {
        ...
        uiHandler = new Handler(new Handler.Callback() {
            ...
            public boolean handleMessage(Message msg) {
                ...
                Log.d("Debug", "server response: " + resp);
                return true;
            }
        });
    }
    ...
    private void sendImage() {
        if(client != null) {
            client = new Client(p2p.getCurrentDeviceAddress(), PORT , uiHandler);
            Bitmap bitmap = BitmapFactory.decodeFile(getPhotoFileUri(photoFileName).getPath());
